...
- **Angular 18** (Componentes Standalone e Signals)
- **Angular Material** (Modais, Inputs, Botões e Spinners)
- **RxJS** (Gerenciamento de streams e operador de Debounce)
- **Vitest / Jest** (Testes unitários automatizados)
